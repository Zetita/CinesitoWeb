...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:TextBox ID="txtNombre" runat="server" CssClass="auto-style1" Width="170px"></asp:TextBox>
    ...
    <asp:TextBox ID="txtApellido" runat="server" style="position:absolute; top:220px; left:925px; margin-left:50px;" Width="170px"></asp:TextBox>
    ...
    <asp:TextBox ID="txtDni" runat="server"  style="position:absolute; top:270px; left:775px" Width="170px"></asp:TextBox>
    ...
    <asp:TextBox ID="txtNacimiento" runat="server"  style="position:absolute; top:270px; left:925px; margin-left:50px;" Width="170px"></asp:TextBox>
    ...
    <asp:TextBox ID="txtEmail" runat="server"  style="position:absolute; top:320px; left:775px; width: 370px;" TextMode="Email"></asp:TextBox>
    ...
    <asp:TextBox ID="txtUsuario" runat="server"  style="position:absolute; top:370px; left:775px;" Width="170px"></asp:TextBox>
    ...
    <asp:TextBox ID="txtTelefono" runat="server"  style="position:absolute; top:370px; left:920px; margin-left:50px;" TextMode="Phone" Width="177px"></asp:TextBox>
    <asp:RequiredFieldValidator ID="rfv8" runat="server" ControlToValidate="txtTelefono" ErrorMessage="*" ForeColor="#CC3300" style="position:absolute; top:350px; left:1130px;"></asp:RequiredFieldValidator>


      <asp:Label ID="Label7" runat="server" Text="Contraseña" ForeColor="White" style="position:absolute; top:400px; left:775px;"></asp:Label>
    <asp:TextBox ID="txtContrasenia" runat="server"  style="position:absolute; top:420px; left:775px; width: 370px;" TextMode="Password"></asp:TextBox>
    <asp:RequiredFieldValidator ID="rfv7" runat="server" ControlToValidate="txtContrasenia" ErrorMessage="*" ForeColor="#CC3300" style="position:absolute; top:400px; left:870px;"></asp:RequiredFieldValidator>
    ...
    <asp:Label ID="lblAdd" runat="server" Text="" ForeColor="White" style="position:absolute; top:450px; left:775px;"></asp:Label>
