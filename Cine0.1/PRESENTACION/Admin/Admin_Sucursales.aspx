...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="Label">
        ...
        <asp:Label ID="Label4" runat="server" Text="Listado de Sucursales y Salas"></asp:Label>
            <br />
            <asp:GridView ID="grdSucursales" runat="server" AllowCustomPaging="True" AutoGenerateColumns="False" AutoGenerateEditButton="True" CssClass="tablalistado" PageSize="5" OnRowDeleting="grdSucursales_RowDeleting" AllowPaging="True">
                <Columns>
            ...
            <br />
            <asp:GridView ID="grdSalas" runat="server" AllowCustomPaging="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" CssClass="tablalistado" PageSize="5" AllowPaging="True">
                <Columns>
