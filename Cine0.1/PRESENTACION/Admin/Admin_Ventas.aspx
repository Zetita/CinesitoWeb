...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="btn12" runat="server" Height="29px" Text="3" Width="30px" style="position:absolute; top: 230px; left: 379px; right: 342px;" OnClick="Colorear2" CommandName="E-3" />
    <asp:Button ID="btn13" runat="server" Height="29px" Text="4" Width="30px" style="position:absolute; top: 230px; left: 415px; right: 306px;" OnClick="Colorear2" CommandName="E-4" />
    <asp:Button ID="btn14" runat="server" Height="29px" Text="5" Width="30px" style="position:absolute; top: 230px; left: 452px; right: 269px;" OnClick="Colorear2" CommandName="E-5" />
    <asp:Button ID="btn15" runat="server" Height="29px" Text="6" Width="30px" style="position:absolute; top: 230px; left: 527px; right: 194px;" OnClick="Colorear2" CommandName="E-6" />
    <asp:Button ID="btn16" runat="server" Height="29px" Text="7" Width="30px" style="position:absolute; top: 230px; left: 566px; right: 155px;" OnClick="Colorear2" CommandName="E-7" />
    ...
    <asp:Button ID="btn19" runat="server" Height="29px" Text="3" Width="30px" style="position:absolute; top: 265px; left: 379px; right: 342px;" OnClick="Colorear2" CommandName="D-3" />
    <asp:Button ID="btn20" runat="server" Height="29px" Text="4" Width="30px" style="position:absolute; top: 265px; left: 414px; right: 307px;" OnClick="Colorear2" CommandName="D-4" />
    <asp:Button ID="btn21" runat="server" Height="29px" Text="5" Width="30px" style="position:absolute; top: 265px; left: 452px; right: 269px;" OnClick="Colorear2" CommandName="D-5" />
    <asp:Button ID="btn22" runat="server" Height="29px" Text="6" Width="30px" style="position:absolute; top: 265px; left: 527px; right: 194px;" OnClick="Colorear2" CommandName="D-6" />
    <asp:Button ID="btn23" runat="server" Height="29px" Text="7" Width="30px" style="position:absolute; top: 265px; left: 566px; right: 155px;" OnClick="Colorear2" CommandName="D-7" />
    ...
    <asp:Button ID="btn26" runat="server" Height="29px" Text="3" Width="30px" style="position:absolute; top: 300px; left: 379px; right: 342px;" OnClick="Colorear2" CommandName="C-3" />
    <asp:Button ID="btn27" runat="server" Height="29px" Text="4" Width="30px" style="position:absolute; top: 300px; left: 415px; right: 306px;" OnClick="Colorear2" CommandName="C-4" />
    <asp:Button ID="btn28" runat="server" Height="29px" Text="5" Width="30px" style="position:absolute; top: 300px; left: 451px; right: 270px;" OnClick="Colorear2" CommandName="C-5" />
    <asp:Button ID="btn29" runat="server" Height="29px" Text="6" Width="30px" style="position:absolute; top: 300px; left: 527px; right: 194px;" OnClick="Colorear2" CommandName="C-6" />
    <asp:Button ID="btn30" runat="server" Height="29px" Text="7" Width="30px" style="position:absolute; top: 300px; left: 566px; right: 127px;" OnClick="Colorear2" CommandName="C-7" />
    ...
    <asp:Button ImageURL="~/Recursos/Asiento-Libre.png" ID="btn31" runat="server" Height="29px" Text="1" Width="30px" style="position:absolute; top: 335px; left: 266px; right: 455px;" OnClick="Colorear2" CommandName="B-1" />
    <asp:Button ImageURL="~/Recursos/Asiento-Libre.png" ID="btn32" runat="server" Height="29px" Text="2" Width="30px" style="position:absolute; top: 335px; left: 303px; right: 418px;" OnClick="Colorear2" CommandName="B-2" />
    <asp:Button ImageURL="~/Recursos/Asiento-Libre.png" ID="btn33" runat="server" Height="29px" Text="3" Width="30px" style="position:absolute; top: 335px; left: 379px; right: 342px;" OnClick="Colorear2" CommandName="B-3" />
    <asp:Button ImageURL="~/Recursos/Asiento-Libre.png" ID="btn34" runat="server" Height="29px" Text="4" Width="30px" style="position:absolute; top: 335px; left: 415px; right: 306px;" OnClick="Colorear2" CommandName="B-4" />
    <asp:Button ImageURL="~/Recursos/Asiento-Libre.png" ID="btn35" runat="server" Height="29px" Text="5" Width="30px" style="position:absolute; top: 335px; left: 451px; right: 270px;" OnClick="Colorear2" CommandName="B-5" />
    <asp:Button ImageURL="~/Recursos/Asiento-Libre.png" ID="btn36" runat="server" Height="29px" Text="6" Width="30px" style="position:absolute; top: 335px; left: 526px; right: 195px;" OnClick="Colorear2" CommandName="B-6" />
    <asp:Button ImageURL="~/Recursos/Asiento-Libre.png" ID="btn37" runat="server" Height="29px" Text="7" Width="30px" style="position:absolute; top: 335px; left: 566px; right: 155px;" OnClick="Colorear2" CommandName="B-7" />
    ...
    <asp:Button ID="btn40" runat="server" Height="29px" Text="3" Width="30px" style="position:absolute; top: 370px; left: 378px; right: 343px;" OnClick="Colorear2" CommandName="A-3" />
    <asp:Button ID="btn41" runat="server" Height="29px" Text="4" Width="30px" style="position:absolute; top: 370px; left: 414px; right: 307px;" OnClick="Colorear2" CommandName="A-4" />
    <asp:Button ID="btn42" runat="server" Height="29px" Text="5" Width="30px" style="position:absolute; top: 370px; left: 452px; right: 269px;" OnClick="Colorear2" CommandName="A-5" />
    <asp:Button ID="btn43" runat="server" Height="29px" Text="6" Width="30px" style="position:absolute; top: 370px; left: 526px; right: 195px;" OnClick="Colorear2" CommandName="A-6" />
    <asp:Button ID="btn44" runat="server" Height="29px" Text="7" Width="30px" style="position:absolute; top: 370px; left: 564px; right: 157px;" OnClick="Colorear2" CommandName="A-7" />
