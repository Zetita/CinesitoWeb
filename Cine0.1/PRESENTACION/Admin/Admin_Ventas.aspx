...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DropDownList ID="ddlPelicula" runat="server" style="position:absolute; top:150px; left:800px; " OnSelectedIndexChanged="DdpPelicula_SelectedIndexChanged"></asp:DropDownList>

    <asp:Label ID="Label2" runat="server" Text="Formato"  style="position:absolute; top:210px;"></asp:Label>
    <asp:DropDownList ID="ddlFormato" runat="server" style="position:absolute; top:210px; left:800px; "></asp:DropDownList>

    <asp:Label ID="Label3" runat="server" Text="Fecha" style="position:absolute; top:270px;"></asp:Label>
    <asp:DropDownList ID="ddlDia" runat="server" style="position:absolute; top:270px; left:800px;"></asp:DropDownList>

    <asp:Label ID="Label4" runat="server" Text="Horario" style="position:absolute; top:330px;"></asp:Label>
    <asp:DropDownList ID="ddlHorario" runat="server" style="position:absolute; top:330px; left:800px;"></asp:DropDownList>
    ...
    <asp:TextBox ID="txtButacas" runat="server" style="position:absolute; top:510px; left:800px;"></asp:TextBox>
