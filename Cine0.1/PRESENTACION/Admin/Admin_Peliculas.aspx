...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label3" runat="server" Text="Listado de Peliculas"></asp:Label>
        <br />
        <asp:GridView ID="grdPeliculas" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" CssClass="tablalistado" OnRowDeleting="grdPeliculas_RowDeleting" OnRowCancelingEdit="grdPeliculas_RowCancelingEdit" OnRowEditing="grdPeliculas_RowEditing" OnRowUpdating="grdPeliculas_RowUpdating" OnPageIndexChanging="grdPeliculas_PageIndexChanging">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Duración">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_eit_Duracion" runat="server" Text='<%# Bind("Duracion") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="TrailerURL">
                    <EditItemTemplate>
                        <asp:TextBox ID="txt_eit_TrailerURL" runat="server" Text='<%# Bind("TrailerURL") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
